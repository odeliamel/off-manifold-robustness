...
class OneLayerClassifier(nn.Module):
    def __init__(self, in_features=3, out_features=40, factor=1):
        ...
        # torch.nn.init.uniform_(self.fc_final.weight, -1, 1)
